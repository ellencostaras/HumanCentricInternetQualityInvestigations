...
Hello! This is a file which contains all the functions necessary for 
parsing Web RTC stats for experiment 1. 

These are only the functions, please refer to the 'running_parsers.py' file 
for the code which actually implements these functions.
